...
export function Modal({ open, onClose, title, children, footer }: {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200" onClick={onClose}>
      <div className="w-full max-w-lg bg-card rounded-2xl border border-border shadow-brand max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
