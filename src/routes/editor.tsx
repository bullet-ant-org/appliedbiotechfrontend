...
import { LayoutDashboard, GraduationCap, ShoppingBag, Layers, User, Image, FileText, Newspaper, Phone, Tag, Receipt, Award } from "lucide-react";
...
const groups: NavGroup[] = [
  ...
  { label: "Content", items: [
    ...
    { label: "Featured Product", to: "/editor/featured", icon: Award },
