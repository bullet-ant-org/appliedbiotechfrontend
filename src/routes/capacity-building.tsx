...
import { GraduationCap, Users, Building2, ArrowRight, Mail, Image as ImageIcon } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-6xl mt-6 flex justify-center">
          <a href="https://drive.google.com/drive/folders/1biEwgOmz6yTBtQFkPG2CuzYRAt-fdwoc" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-5 py-3 text-sm font-semibold hover:bg-accent transition-colors">
            <ImageIcon className="h-4 w-4" /> View Photos from Past Workshops
          </a>
        </div>
